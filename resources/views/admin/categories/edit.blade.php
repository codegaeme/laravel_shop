                        ...
                        <div class="col-lg-12">
                            <div class="card mb-8 rounded-4">
                                ...
                                <div class="card-body p-7">
                                    <form class="form-border-1" action="{{ route('admin.categories.update',$detailCate->id) }}"
                                        ...
                                        <div class="mb-8">
                                            ...
                                            <input type="text" placeholder="Type here" class="form-control"
                                                name="img_name" id="product_title" value="{{$detailCate->img_name}}">
                                            @error('img_name')
                                        ...
                                        <div class="mb-8">
                                            <label for="product_title"
                                                class="mb-4 fs-13px ls-1 fw-bold text-uppercase">Ảnh</label><br>
                                                <img src="{{Storage::url($detailCate->img_cate)}}" alt="" width="100px" class="mt-4 mb-4">
                                            <input type="file" placeholder="Type here" class="form-control"
                                                name="img_cate" id="product_title" value="{{$detailCate->img_cate}}">
                                            @error('img_cate')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <label class="form-check mb-5 col-sm-66" for="make-template">
                                            ...
                                            <input class="form-check-input" type="radio" value="2" @if ($detailCate->status==2)
                                            checked
                                            @endif name="status"
                                                id="make-template">
                                        ...
                                        <label class="form-check mb-5 col-sm-6" for="make-template">
                                            <input class="form-check-input" type="radio" value="1" name="status"
                                                id="make-template" @if ($detailCate->status==1)
                                                checked
                                                @endif>
                                            <span class="form-check-label"> Hiển thị </span>
                                        </label>

                                        <button class="btn btn-success mt-5">Sửa </button>
                                    </form>
                                </div>
                            </div>
