                                ...
                                <div class="new-member-list">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="w-40px me-5">
                                                <img src="#"
                                                    data-src="{{ asset('') }}//images/dashboard/avatar-4.png')}}"
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="w-40px me-5">
                                                <img src="#"
                                                    data-src="{{ asset('client/assets//images/dashboard/avatar-2.png') }}"
                                                    alt class="lazy-image rounded-circle"
                                                    height="40" width="40">
                                            </div>
                                            <div>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="w-40px me-5">
                                                <img src="#"
                                                    data-src="{{ asset('client/assets//images/dashboard/avatar-3.png') }}"
                                                    alt class="lazy-image rounded-circle"
                                                    height="40" width="40">
                                            </div>
                                            <div>
