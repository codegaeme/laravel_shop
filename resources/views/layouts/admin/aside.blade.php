    ...
    <div class="sticky-area border-right">
        <div class="d-flex px-6 px-xl-10 w-100 border-bottom py-7 justify-content-between">
            <a href="../index-2.html" class="navbar-brand py-4">
                <img class="light-mode-img" src="{{ asset('client/assets/images/others/logo.png') }}"
                    width="179" height="26" alt="Glowing - Bootstrap 5 HTML Templates">
                <img class="dark-mode-img"
                    src="{{ asset('client/assets/images/others/logo-white.png') }}" width="179"
                        ...
                        <ul class="sub-menu list-unstyled">
                            <li class="sidebar-item">
                                <a class="sidebar-link pe-5 ps-8 py-5 lh-1 text-decoration-none fs-14px fw-semibold"
                                    href="sellers-cards.html" title="Sellers Cards">List User</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="list-group-item px-0 py-0 sidebar-item mb-3 has-children border-0">
                    ...
                    <div class="collapse menu-collapse" id="add_product">
                        <ul class="sub-menu list-unstyled">
                            <li class="sidebar-item">
                                <a class="sidebar-link pe-5 ps-8 py-5 lh-1 text-decoration-none fs-14px fw-semibold"
                                    href="{{route('admin.categories.index')}}" title="Add Product 1">List Categories</a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link pe-5 ps-8 py-5 lh-1 text-decoration-none fs-14px fw-semibold"
                                    href="{{route('admin.categories.create')}}" title="Add Product 1">Add Categories</a>
                            </li>
