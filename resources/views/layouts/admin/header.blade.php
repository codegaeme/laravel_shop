            ...
            <div
                ...
                <div class="dropdown px-4 mx-3 py-2 dropdown-language">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item text-brand" href="#"><img
                                src="{{ asset('client/assets/images/dashboard/flag-us.png') }}"
                                alt="English">English</a>
                        <a class="dropdown-item" href="#"><img
                                src="{{ asset('client/assets/images/dashboard/flag-fr.png') }}"
                                alt="Français">Français</a>
                        <a class="dropdown-item" href="#"><img
                                src="{{ asset('client/assets/images/dashboard/flag-jp.png') }}"
                                alt="Français">Français</a>
                        <a class="dropdown-item" href="#"><img
                                src="{{ asset('client/assets/images/dashboard/flag-cn.png') }}"
                                alt="Français">Français</a>
                    </div>
                </div>
                <div class="dropdown pl-2 py-2">
                    <a href="#"
                        ...
                        data-bs-toggle="dropdown">
                        <img src="{{ asset('client/assets/images/dashboard/avatar-2.png') }}"
                            alt="Ronald Hunter" class="rounded-circle" width="40">
                    </a>
                    <div class="dropdown-menu dropdown-menu-end w-100">
                        @if (Auth::check())
                        <a class="dropdown-item" href="{{ route('profile.admin', [Auth::user()->id]) }}">My Profile</a>
                        @endif
